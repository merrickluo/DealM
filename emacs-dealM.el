;; -*- Emacs-Lisp -*-
;; Last modified: <2012-07-26 08:24:37 Thursday by richard>
...
(defconst emacs-root-path
  (file-name-directory (buffer-file-name)) "Emacs root settings path (in linux)")
(defconst plugins-path-r
  (concat emacs-root-path "plugins/" separator) "Reference path of emacs lisp package")
